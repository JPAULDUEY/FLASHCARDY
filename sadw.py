...
class FlashcardApp:
    ...
    def learn_mode_tab(self):
        ...
        self.word_label = tk.Label(frame, text='', font=('Times New Roman', 24, 'bold'), background='#FF7043', foreground='black')
        self.word_label.pack(padx=5, pady=40)

        # Definition label with black color, Times New Roman font, and font size 20
        self.definition_label = tk.Label(frame, text='', font=('Times New Roman', 20), background='#FF7043', foreground='black')
